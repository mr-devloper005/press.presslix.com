...
const inputClass = 'h-[3.35rem] rounded-md border border-[#d8deea] bg-white px-4 text-base font-bold text-[#141a26] outline-none transition placeholder:text-[#667085] focus:border-[var(--slot4-accent)] focus:ring-4 focus:ring-[var(--slot4-accent-soft)]'
const buttonClass = 'inline-flex h-[3.35rem] items-center justify-center rounded-md bg-[var(--slot4-accent)] px-6 text-sm font-black uppercase text-white transition hover:bg-[#163273] disabled:opacity-60'
